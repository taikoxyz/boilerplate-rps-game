...
export class RPS extends ethereum.SmartContract {
  ...
  entries(participantHash: Bytes): RPS__entriesResult {
    let result = super.call('entries', 'entries(bytes32):(address,uint256,uint8,uint256)', [
      ethereum.Value.fromFixedBytes(participantHash),
    ]);

    return new RPS__entriesResult(result[0].toAddress(), result[1].toBigInt(), result[2].toI32(), result[3].toBigInt());
  }

  try_entries(participantHash: Bytes): ethereum.CallResult<RPS__entriesResult> {
    let result = super.tryCall('entries', 'entries(bytes32):(address,uint256,uint8,uint256)', [
      ethereum.Value.fromFixedBytes(participantHash),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    return ethereum.CallResult.fromValue(
      new RPS__entriesResult(value[0].toAddress(), value[1].toBigInt(), value[2].toI32(), value[3].toBigInt()),
    );
  }
  ...
  getEntry(participantHash: Bytes): RPS__getEntryResultValue0Struct {
    let result = super.call('getEntry', 'getEntry(bytes32):((address,uint256,uint8,uint256))', [
      ethereum.Value.fromFixedBytes(participantHash),
    ]);
  ...
  try_getEntry(participantHash: Bytes): ethereum.CallResult<RPS__getEntryResultValue0Struct> {
    let result = super.tryCall('getEntry', 'getEntry(bytes32):((address,uint256,uint8,uint256))', [
      ethereum.Value.fromFixedBytes(participantHash),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(changetype<RPS__getEntryResultValue0Struct>(value[0].toTuple()));
  }

  getParticipantHash(owner: Address, tokenId: BigInt): Bytes {
    let result = super.call('getParticipantHash', 'getParticipantHash(address,uint256):(bytes32)', [
  ...
  try_getParticipantHash(owner: Address, tokenId: BigInt): ethereum.CallResult<Bytes> {
    let result = super.tryCall('getParticipantHash', 'getParticipantHash(address,uint256):(bytes32)', [
      ethereum.Value.fromAddress(owner),
      ethereum.Value.fromUnsignedBigInt(tokenId),
    ]);
    if (result.reverted) {
  ...
  isRegistrationOpen(): boolean {
    let result = super.call('isRegistrationOpen', 'isRegistrationOpen():(bool)', []);

    return result[0].toBoolean();
  }

  try_isRegistrationOpen(): ethereum.CallResult<boolean> {
    let result = super.tryCall('isRegistrationOpen', 'isRegistrationOpen():(bool)', []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_register(tokenId: BigInt, move: i32): ethereum.CallResult<Bytes> {
    let result = super.tryCall('register', 'register(uint256,uint8):(bytes32)', [
      ethereum.Value.fromUnsignedBigInt(tokenId),
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(move)),
    ]);
    if (result.reverted) {
  ...
  registerPlayer(_player: Address, _tokenId: BigInt, _move: i32): Bytes {
    let result = super.call('registerPlayer', 'registerPlayer(address,uint256,uint8):(bytes32)', [
  ...
  try_registerPlayer(_player: Address, _tokenId: BigInt, _move: i32): ethereum.CallResult<Bytes> {
    let result = super.tryCall('registerPlayer', 'registerPlayer(address,uint256,uint8):(bytes32)', [
      ethereum.Value.fromAddress(_player),
      ethereum.Value.fromUnsignedBigInt(_tokenId),
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(_move)),
    ]);
