...
export class RpsGame extends Entity {
  ...
  static loadInBlock(id: Bytes): RpsGame | null {
    return changetype<RpsGame | null>(store.get_in_block('RpsGame', id.toHexString()));
  }
  ...
  get participants(): ParticipationTokenLoader {
    return new ParticipationTokenLoader('RpsGame', this.get('id')!.toBytes().toHexString(), 'participants');
  }
